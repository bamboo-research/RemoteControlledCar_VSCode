...
enum EBluetoothAdapter { HC_05, HC_06 };	//HC_06 is both Master/Slave. HC_05 only Slave
enum EATCommand { AT, AT_VERSION, AT_DEVICE_NAME, AT_BAUD, AT_PIN, AT_PARITY,	//common for both adapters
